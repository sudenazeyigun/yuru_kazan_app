    ...
    return SafeArea(
      ...
      Positioned(
        ...
        child: ElevatedButton(onPressed: () async{
          ...
          markers.add(Marker(markerId: const MarkerId('positionStream '),position: LatLng(position.latitude, position.longitude)));
          markers.add(Marker(markerId: const MarkerId('value'),position: LatLng(position.latitude, position.
          longitude)));
